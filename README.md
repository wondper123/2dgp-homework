...
# 기말 프로젝트를 하며 겪은 어려움
내가 무엇을 개발하고 싶었는지, 개발에 대한 생각이 어떻게 잡혀 있는지 잘 모르겠다. 무언가를 개발하는 것에 크게 흥미를 느끼지 못한다고 생각한다. 내가 무엇을 개발하고 싶은지 구체화하는 작업을 건너뛴 것 같아 개발을 진행하는데 어려움이 있었다. 무엇을 개발하려는 건지 뚜렷한 목표를 가지지 않으니 잡고 있어도 뭘 하는지 잘 모르는 상태였다. 진전없이 시간낭비만 한 듯 하다.
